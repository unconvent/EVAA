...
import { ViralImagesStudio } from "@/components/viral-images-studio";
import { FloatingActions } from "@/components/floating-actions";

export const dynamic = "force-dynamic";

export default async function ViralImagesPage() {
  ...
  if (!supabase) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-20 text-slate-100">
        ...
        <p className="mt-3 text-[var(--muted)]">Add NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY to enable authentication for the demo.</p>
      </div>
    );
  }
